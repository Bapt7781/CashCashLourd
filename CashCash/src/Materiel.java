...
public class Materiel {
    ...
    public String xmlMateriel() {
        ...
        xmlBuilder.append("<type refInterne=\"").append(leType.getReferenceInterne()).append("\" libelle=\"")
                .append(leType.getLibelleTypeMateriel()).append("\"/>\n");
        xmlBuilder.append("<famille codeFamille=\"").append(leType.getLaFamille().getCodeFamille())
                .append("\" libelle=\"").append(leType.getLaFamille().getLibelleFamille()).append("\"/>\n");
